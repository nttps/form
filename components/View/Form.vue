<template>
    ...
    >
        <div class="text-center bg-[#ffc583] rounded-t-lg py-2"></div>
        <div class="p-4 bg-white border-l border-r border-b border-[#ffc583]">
            <div class="mb-2">
                ...
                <p class="text-lg code-description p-0 el-tiptap-editor__content" v-if="question.quiz.quiz_desc && props.form.submit.survey_type  !==  'ระบบโหวต'" v-dompurify-html="question.quiz.quiz_desc"></p>
            </div>
